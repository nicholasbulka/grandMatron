...
//==============================================================================
MatriarchFilterAudioProcessorEditor::MatriarchFilterAudioProcessorEditor (MatriarchFilterAudioProcessor& p)
    : AudioProcessorEditor (&p), mAudioProcessor (p)
{
    ...
    cutoffFrequencyAttachment.reset(
        new juce::AudioProcessorValueTreeState::SliderAttachment(
            mAudioProcessor.getAudioProcessorValueTreeState(), "cutoff_frequency", cutoffFrequencySlider));
    ...
    highpassAttachment.reset(
        new juce::AudioProcessorValueTreeState::ButtonAttachment(
            mAudioProcessor.getAudioProcessorValueTreeState(), "highpass", highpassButton));
...
MatriarchFilterAudioProcessorEditor::~MatriarchFilterAudioProcessorEditor()
{
}

//==============================================================================
void MatriarchFilterAudioProcessorEditor::paint (juce::Graphics& g)
{
...
void MatriarchFilterAudioProcessorEditor::resized()
{
