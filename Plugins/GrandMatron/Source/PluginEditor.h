...
struct PathProducer
{
  PathProducer(SingleChannelSampleFifo<GrandMatronAudioProcessor::BlockType>& scsf) :
...
private:
  SingleChannelSampleFifo<GrandMatronAudioProcessor::BlockType>* leftChannelFifo;
...
struct ResponseCurveComponent: juce::Component,
                              ...
                              juce::Timer
{
  ResponseCurveComponent(GrandMatronAudioProcessor&);
...
private:
  GrandMatronAudioProcessor& audioProcessor;
...
private:
  ...
  ButtonAttachment highPassBypassButtonAttachment,
      peakBypassButtonAttachment,
      lowPassBypassButtonAttachment,
