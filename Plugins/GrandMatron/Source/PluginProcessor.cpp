...
void GrandMatronAudioProcessor::updateFilters()
{
...
juce::AudioProcessorValueTreeState::ParameterLayout GrandMatronAudioProcessor::createParameterLayout()
{
  ...
  juce::ParameterID lowPassFreqId = {"lowPass Freq", 1};
  ...
  juce::ParameterID lowPassSlopeId = {"lowPass Slope", 1};
  juce::ParameterID lowPassBypassedId = {"lowPass Bypassed", 1};
